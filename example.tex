...
\title{全国大学生数学建模竞赛编写的11 \LaTeX{} 模板}
\tihao{A}
\baominghao{4321}
\schoolname{XX大学}
\membera{ }
...
\centerline{\includegraphics[width=6cm]{figures/gongzhonghao2}}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.3\textwidth}
        \centering
        \includegraphics[width=0.95\textwidth]{figures/f1}
        \subcaption{流程图}
...
\begin{figure}
    ...
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{figures/cat}
        \subcaption{一只猫}
    \end{minipage}
    \begin{minipage}[c]{0.48\textwidth}
        \centering
        \includegraphics[height=0.2\textheight]{figures/smokeblk}
        \subcaption{电路图}
    \end{minipage}
    \caption{多图并排示例}
\end{figure}
...
\begin{table}[!htbp]
    ...
    \begin{tabular}{ccccc}
        ...
        20 & 640.2 & 0.001565 & 7.18 & 0.04089\\ \bottomrule[1.5pt]
    \end{tabular}
\end{table}
...
中文字体没有斜体设计，但是英文字体有。textit{斜体 Italics}。
